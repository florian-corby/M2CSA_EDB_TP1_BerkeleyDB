...
public class BasicDbManager extends EnvDbManager {
	...
	public void setupDb() throws Exception {
		Database clientDb = createDb(BasicClientDAO.DB_NAME);
		clientDb.close();
...
//		dbConfig.setType(DatabaseType.BTREE);
		return env.openDatabase(null, fileName, dbConfig);
	}
...
//		idxConfig.setType(DatabaseType.DB_BTREE);
		idxConfig.setSortedDuplicates(true);
		idxConfig.setKeyCreator(indexKey);
		return env.openSecondaryDatabase(null, fileName, db, idxConfig);
	}
